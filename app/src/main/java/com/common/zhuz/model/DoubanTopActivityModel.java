...
public class DoubanTopActivityModel {

    public void getMovieTop250( int mStart, int mCount, final CallBackCustomFragment callBackCustomFragment){
        Http.getAPI_DOUBAN(UrlHelper.API_DOUBAN).getMovieTop250(mStart,mCount)
